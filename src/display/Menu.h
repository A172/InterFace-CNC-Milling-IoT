...
public:
  ...
  void showStandby(float x = 0.0, float y = 0.0, float z = 0.0, const char *eta = nullptr, const char *jobName = nullptr, int progress = -1, const char *timeStr = nullptr, const char *machineStatus = nullptr, const char *networkStatus = nullptr);
